...
public class MainActivity extends AppCompatActivity {
    ...
    private FontedTextView progressBarTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBarTextView = (FontedTextView) findViewById(R.id.textViewProgressBar);
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            if (bashIsReachable) {
                ...
                hideQuotesView();
                mEmptyStateTextView.setText(R.string.unreachable);
            }
